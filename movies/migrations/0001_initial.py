# Generated by Django 3.2.5 on 2021-07-19 07:51
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=150, verbose_name='Катигорія')),
                ('description', models.TextField(verbose_name='Опис')),
                ('url', models.SlugField(max_length=160, unique=True)),
            ],
            options={
                'verbose_name': 'Категорія',
                'verbose_name_plural': 'Катигорії',
            },
        ),
        migrations.CreateModel(
            name='Genre',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(verbose_name='Опис')),
                ('poster', models.ImageField(upload_to='django_movies/', verbose_name='Постер')),
                ...
                ('fees_in_usa', models.PositiveIntegerField(default=0, verbose_name='Збори в США')),
                ('fess_in_world', models.PositiveIntegerField(default=0, verbose_name='збори в світі')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(verbose_name='Опис')),
                ('image', models.ImageField(upload_to='movie_shots/', verbose_name='зображеня')),
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movies.movie', verbose_name='Фільм')),
            ],
            options={
                'verbose_name': 'Кадр із фільма',
                'verbose_name_plural': 'Кадри із фільма',
            },
        ),
    ]
